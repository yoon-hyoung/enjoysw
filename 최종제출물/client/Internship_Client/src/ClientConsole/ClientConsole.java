         ...
         switch(inputNum) {
          ...
          case 1:{
            ...
            e.printStackTrace();
             ...
             for(int i = 0;i<5;i++) System.out.println("");
             if(inputNum==1) {
            	 System.out.println("============= Print Private Information ============= ");
                student.print_info(); // 1甕곕뜆�뵬 野껋럩�뒭
             }
             else if(inputNum==2)
            	  {System.out.println("============= Print Applied Intership  ============= ");
          ...
          case 2:{
            ...
            e.printStackTrace();
             ...
             if(inputNum==1)
            	 System.out.println("============= Print Detail of Internship  ============= ");
             
             else if(inputNum==2)
                //占쎌뵥占쎄쉘占쎈뤊 占쎈뻿筌ｏ옙
            	{System.out.println("============= Apply Intership  ============= ");
                student.print_apply_internship();
            	}
             else if(inputNum==3)
            	 System.out.println("============= Cancel Internship  ============= ");
            ...
            e.printStackTrace();
             ...
             if(inputNum==1)
                ...
                //student.delDocu(del_file);
            	 ...
            	 System.out.println("============= Print Document List  ============= ");
            	 student.getDocu().PrintDocumentList();
            	 }
                //student.printDocu();
          ...
          case 4:{
        	  System.out.println("============= Review of Internship  ============= ");
            ...
            e.printStackTrace();
             ...
             if(inputNum==1)
               ...
               // student.write_review(review_internship, write_review_name);
            	   ...
            	   System.out.println("============= Print Review List ============= ");
               // student.print_review_All(review_internship, print_review);
                
             else if(inputNum==3)
               // student.print_review_All(review_internship, print_review);
            	  System.out.println("============= Print Detail of Review  ============= ");
